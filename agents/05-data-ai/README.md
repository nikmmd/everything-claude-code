...
### [**ml-engineer**](ml-engineer.md) - Machine learning systems and model optimization specialist
ML engineering specialist building end-to-end machine learning systems. Masters the entire ML lifecycle from training pipelines to production deployment. Covers model optimization, serving infrastructure, and automated retraining.

**Use when:** Building ML pipelines, training and optimizing models, deploying ML systems, creating ML infrastructure, or productionizing ML solutions.
...
| Build/train ML systems | **ml-engineer** |
...
- Core **database-designer** for schema and query optimization
- **data-analyst** for insights

**Production ML:**
- **ml-engineer** for ML systems and optimization
