...
- Core **refactor-cleaner** for dead code removal
- **dependency-manager** for package updates
- Core **doc-updater** for documentation sync
...
**Tool Development:**
- **tooling-engineer** for CLI tools and IDE integration
- **readme-generator** for tool documentation
- **build-engineer** for tool packaging

**Repository Documentation:**
- **readme-generator** for maintainer-ready README creation
- Core **doc-updater** for codemap and docs sync
- **git-workflow-manager** for repo workflow notes

**Code Quality:**
- Core **refactor-cleaner** for dead code cleanup
- **dependency-manager** for package health
- Core **code-reviewer** for review
- **git-workflow-manager** for branching strategy
