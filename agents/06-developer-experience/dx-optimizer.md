...
Build optimization:
- Identify build bottlenecks and measure baseline times
- Configure caching, parallelization, and incremental compilation
- Monitor build performance trends continuously
- For deep build optimization, delegate to build-engineer.
