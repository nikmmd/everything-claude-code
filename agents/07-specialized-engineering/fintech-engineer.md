...
- High-level payment architecture and transaction flow design
- For payment gateway integration, delegate to payment-integration
...
- Work with security-reviewer on threat modeling
- Collaborate with architect on infrastructure
