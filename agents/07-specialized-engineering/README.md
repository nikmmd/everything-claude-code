...
### [**m365-admin**](m365-admin.md) - Microsoft 365 administration specialist
M365 expert automating Exchange Online, Teams, SharePoint, and identity management via Graph API and PowerShell. Handles mailbox provisioning, license lifecycle, and tenant configuration.

**Use when:** Automating M365 admin tasks, provisioning Exchange mailboxes, managing Teams/SharePoint, scripting Graph API operations, or handling license management.
...
| Financial Tech | **fintech-engineer** | Banking, compliance, trading |
| Microsoft 365 | **m365-admin** | Exchange, Teams, Graph API |
...
| Payments | **payment-integration** | Payment gateways, PCI, checkout |
